...
source(here::here("R/Get_LRP_bs.R")) # Also attaches TMB's package
...
# What inputs are required?
  ...
  # bs_seed # bs
  # bs_nBS # bs
  # remove.EnhStocks # data exclusions
  # plot # type of outputs
  # est.table # type of outputs
...
rtmb_bootout <- dfout # This is a direct match of the IWAM_model.R

# IWAM_model.R's return out:
# return(list(opt = opt, # here
#             dataname = datain, # here
#             dfout, # from bootstrapping - not available here - unless bootstrapping function is added
#             modelpars = pars, # here
#             all_Deltas = all_Deltas, # here 
#             srdat = srdat, # here
#             lh = lifehist, # here 
#             WAbase = WAbase, # here
#             pred_lnSREP = pred_lnSREP, # here
#             pred_lnSMSY = pred_lnSMSY, # here
#             pred_lnSREP_pi = pred_lnSREP_pi, # here
#             pred_lnSMSY_pi = pred_lnSMSY_pi, # here
#             pred_lnWA = dat$pred_lnWA, # here
#             SRes = SRes, # here
#             r2 = r2 # here
# ))
