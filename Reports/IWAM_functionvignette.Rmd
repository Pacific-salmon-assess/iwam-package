...
In the example here, using a West Coast Vancouver Island Stocks data-set, the function parameters will read:
...
For comparison to (INSERT PAPER), please find Tables 1-3.
