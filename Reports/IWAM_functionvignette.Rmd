...
data <- Parken %>% left_join(SMSY, by=join_by(Stock)) %>% 
...
``` {r SMSY comparison fig, echo=FALSE, message=FALSE, fig.align = 'center'}
...
``` {r SREP comparison fig, echo=FALSE, message=FALSE, fig.align = 'center'}
