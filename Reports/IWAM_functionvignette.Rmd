...
```{r SREP noenh, echo=FALSE, message=FALSE}
...
```{r SGEN noenh, echo=FALSE, message=FALSE}
...
```{r SMSY noenh, echo=FALSE, message=FALSE}
...
```{r SREP wenh, include=FALSE, echo=FALSE, message=FALSE}
...
```{r SGEN wenh, include=FALSE, echo=FALSE, message=FALSE}
...
```{r SMSY wenh, include=FALSE, echo=FALSE, message=FALSE}
...
``` {r combo wenh, echo=FALSE, message=FALSE}
combo <- data.frame(SGEN_noenh, SREP_noenh, SMSY_noenh)
combo <- combo %>% 
...
``` {r CSAS, echo=FALSE, message=FALSE}
