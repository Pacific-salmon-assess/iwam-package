...
The following tables (1-3) have been prepared for comparison to Holt et al. (2023) Res Doc (Table 9).
...
The objective of this section is to provide comparison figures between the IWAM function's estimates of SMSY and SREP to the Parken model estimates.
